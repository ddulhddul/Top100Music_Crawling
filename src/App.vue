<template>
  <div>
    <div>
      ...
      <div id="playerEmbedDiv" :style='{display: videoHidden? "none": "block"}'>
        <div id="player"></div>
      </div>
      <div style="text-align:right; margin:5px 0px -10px 0px;">
        <button id="playerHiddenBtn" @click='videoHidden=!videoHidden' class="btn btn-dark btn-xs">hidden</button>
      </div>
